...
#pragma warning restore IDE0060 // Remove unused parameter
    ...
    [TestClass] public class _1_DefaultHappyPath 
        : EnumValuesTestCase<Cases._1_DefaultHappyPath>;
    [TestClass] public class _2_DefaultUndefinedValue() : EnumValuesTestCase<Cases._2_DefaultUndefinedValue>
        .WithCodeFix<MissingEnumValueCodeFix>([EnumValuesGenerator.MissingEnumValueDescriptor]);
    ...
    [TestClass] public class _6_Flags_5_MissingFlagWarning() : EnumValuesTestCase<Cases._6_Flags._5_MissingFlagWarning>([EnumValuesGenerator.UndefinedEnumFlagMemberDescriptor], ignoreSources: true);
    [TestClass] public class _6_Flags_6_MissingNoneWarning() : EnumValuesTestCase<Cases._6_Flags._6_MissingNoneWarning>([EnumValuesGenerator.UndefinedEnumFlagMemberDescriptor], ignoreSources: true);
    [TestClass] public class _7_GenericEnumIsNotSupportedWarning() : EnumValuesTestCase<Cases._7_GenericEnumIsNotSupportedWarning>
        .WithCodeFix<EnumTypeInGenericCodeFix>([EnumValuesGenerator.EnumTypesInGenericsNotSupportedDescriptor]);
    [TestClass] public class _8_EnumAliasesCanBeUnstableWarning() : EnumValuesTestCase<Cases._8_EnumAliasesCanBeUnstableWarning>([EnumValuesGenerator.RemoveDuplicateEnumValueDescriptor], ignoreSources: true);
}
